...
namespace CatchMe.Helpers
{
    ...
    public class CacheHelper
    {
        ...
        public static void AddObjectToCache(string key, object objectToInsert, DateTime? expirationTime, string userId, AppEnums.CacheExpiration expiration)
        {
        ...
        public static void AddObjectToCache(string key, object objectToInsert, DateTime? expirationTime, bool ObjectIsPerPerson, AppEnums.CacheExpiration expiration)
        {
    ...
    public static class CacheHelperKeys
    {
        ...
        public readonly static string CK_ALL_PAGES = "CK_ALL_PAGES";
        public readonly static string CK_ALL_LINKS = "CK_ALL_LINKS";
